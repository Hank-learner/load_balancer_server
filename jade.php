...
$sql = "SELECT ID, start_time, CPU_required, Memory_required, time_required_for_completion FROM requests WHERE allocated_node_name = 'jade' ";
...
echo "<p>Jade Running Processes</p>";
echo "<br>";
